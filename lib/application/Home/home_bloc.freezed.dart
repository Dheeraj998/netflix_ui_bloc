...
class _$HomeStateTearOff {
  ...
  _Initial call(
      ...
      required List<HotAndNewData> tenseDramaMoieList,
    ...
    return _Initial(
      ...
      tenseDramaMoieList: tenseDramaMoieList,
...
mixin _$HomeState {
  ...
  List<HotAndNewData> get trendingMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get tenseDramaMoieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> tenseDramaMoieList,
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? tenseDramaMoieList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      trendingMovieList: trendingMovieList == freezed
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tenseDramaMoieList: tenseDramaMoieList == freezed
          ? _value.tenseDramaMoieList
          : tenseDramaMoieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required this.tenseDramaMoieList,
  ...
  @override
  final List<HotAndNewData> tenseDramaMoieList;
  @override
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tenseDramaMoieList: $tenseDramaMoieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.tenseDramaMoieList, tenseDramaMoieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(tenseDramaMoieList),
